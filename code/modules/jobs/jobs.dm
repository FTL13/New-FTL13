GLOBAL_LIST_INIT(command_positions, list(
	"Captain",
	"Executive Officer", //FTL13: was Head of Personnel
	"Head of Security",
	"Chief Engineer",
	"Research Director",
...
/proc/get_full_job_name(job)
	...
	var/static/regex/hop_expand = new("hop|xo") //FTL13: this shouldnt conflict with anything, probably safe
	...
	job = hop_expand.Replace(job, "executive officer") //FTL13: might conflict
