...
/datum/controller/subsystem/player_ship/Initialize(timeofday)
	. = ..()
...
/datum/controller/subsystem/player_ship/proc/ship_destruction()
	return

/datum/controller/subsystem/player_ship/proc/get_dodge_chance() //Make this more advanced later
	return dodge_chance
